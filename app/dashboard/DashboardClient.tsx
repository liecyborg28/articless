...
export default function DashboardClient() {
  // 🔽 semua isi fungsi Dashboard kamu, persis seperti sebelumnya
  ...
  // ... seluruh state dan function seperti handleGetSummary, handleFileChange, dsb
